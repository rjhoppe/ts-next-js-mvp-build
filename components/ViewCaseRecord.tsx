                ...
                <div className="flex flex-col gap-5">
                  ...
                  {typeof phone_numbers === "object" ? (
                    <Textarea
                      ...
                      startContent={phone_numbers.join(", ")}
                    />
                  ) : (
                    <Input
                      readOnly
                  ...
                  ></Input>
                  <Textarea label="Case Notes" placeholder="Enter your notes" />
                </div>
              </ModalBody>
              <ModalFooter>
