...
const AddVictim = ({ caseNumber, victim_phone_numbers, victim_emails, victim_names }: AddVictimProps) => {
          ...
          <div className="px-1 py-2 w-full">
            ...
            <div className="mt-2 flex flex-col gap-2 w-full">
              ...
              <Input 
                ...
                errorMessage={isPhoneNumberInvalid && "Please enter a valid phone number"}
                onValueChange={setPhoneNumber}
                isDisabled={inputState}
              />
              <Button 
                color={inputState === true ? 'success': 'primary'}
                isDisabled={isEmailInvalid || isNameInvalid || isPhoneNumberInvalid || inputState}
